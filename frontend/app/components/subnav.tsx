...
const SubNav = () => {
  return (
    <div className="w-full px-20  flex items-center justify-center text-center bg-gradient-to-tr from-gray-300 via-gray-100 to-white text-black border-b border-gray-200 ">
      <div className="max-w-7xl mx-auto px-4">
        <nav className="flex items-center gap-6 h-12 overflow-x-auto text-sm font-medium">
          
          <Link href="/deals" className="text-red-800 hover:text-red-600 whitespace-nowrap">
            🔥 Deals
          </Link>
