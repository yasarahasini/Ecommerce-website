    ...
    <div className="min-h-screen">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-center text-white px-6">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-lime-500 to-blue-500 text-black font-bold px-6 py-3 rounded-lg hover:scale-105 transition animate-fadeIn"
          >
            Shop Now
          </Link>
        </div>
