...
export default function BabyCollectionPage() {
  ...
  return (
    <div className="bg-gradient-to-tr from-pink-500 via-pink-200 to-pink-200 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-6">

        <header className="text-center mb-16">
          <span className="text-rose-500 font-semibold tracking-widest uppercase text-sm">Premium Quality</span>
          <h1 className="text-5xl font-serif font-bold text-gray-900 mt-2 mb-4">Baby Collection</h1>
          <p className="text-gray-700 max-w-lg mx-auto italic">
